...
export default function DocumentComparisonPage() {
  ...
  const handleCompare = async () => {
    ...
    setIsComparing(true);
    toast.info("AI is analysing your documents...");
    ...
    const result = {
      ...
      additions: [
        "Document B includes a force majeure clause",
        "Document B has additional indemnification provisions",
      ],
            ...
            <div className="mx-auto max-w-3xl">
              <div className="mb-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Upload exactly 2 PDF or DOC files to compare. Our AI will
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-6">
                  <div className="rounded-xl border border-border bg-card p-6">
                    ...
                    <ul className="space-y-3">
                      {comparisonResult.additions.map(
                        (add: string, index: number) => (
                          <li
                            key={index}
                            className="flex items-start gap-2 text-sm"
                          >
                  ...
                  <div className="rounded-xl border border-border bg-card p-6">
                    ...
                    <ul className="space-y-3">
                      {comparisonResult.removals.map(
                        (rem: string, index: number) => (
                          <li
                            key={index}
                            className="flex items-start gap-2 text-sm"
                          >
